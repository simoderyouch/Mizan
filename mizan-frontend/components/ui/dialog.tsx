...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-[95vw] max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-xl border border-outline-variant/20 bg-surface-container-lowest p-6 shadow-sanctuary-lg",
        className
      )}
      {...props}
    >
