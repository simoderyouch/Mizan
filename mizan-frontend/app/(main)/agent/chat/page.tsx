...
export default function AgentChatPage() {
  ...
  return (
    <div className="relative flex flex-col border  border-2 rounded-xl items-center w-full h-[calc(100vh-8.5rem)] md:h-[calc(100vh-7rem)] overflow-hidden">



      {mode === "text" ? (
        <div className="relative z-10 flex flex-col w-full h-full max-w-4xl px-2 sm:px-4">
          ...
          {/* Chat History Area */}
          <div className="flex-1 min-h-0 overflow-y-auto w-full pb-32 scrollbar-none [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          <div className="absolute bottom-6 left-0 w-full px-2 sm:px-4 z-20">
        ...
        <div className="absolute inset-0 z-50 flex flex-col bg-surface/95 backdrop-blur-2xl animate-in fade-in zoom-in-95 duration-300">
