...
export type EveningCheckinFlowProps = {
  embedded?: boolean;
  onBack?: () => void;
  onOpenVoice?: () => void;
  onComplete?: () => void;
...
export function EveningCheckinFlow({
  ...
  const openVoice = () => {
    ...
    router.push("/checkin/voice?period=EVENING&return=/checkin/evening");
  };
    ...
    <div className={`page-enter max-w-2xl mx-auto px-1 ${embedded ? "pb-4" : "pb-16"}`}>
      ...
      {step === "result" && report && (
        <div className="page-enter space-y-8">
          ...
          <Button onClick={finish} size="lg" className="w-full h-14 text-lg rounded-xl shadow-lg">
