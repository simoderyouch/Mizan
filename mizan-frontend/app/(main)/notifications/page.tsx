...
import {
  ...
  FileText, CheckCircle2, ChevronLeft, RefreshCw, Trash2
} from "lucide-react";
      ...
      {error && (
        <Card className="border-red-200 bg-red-50">
          <CardContent className="py-4 flex items-center justify-between">
            ...
            <Button variant="link" size="sm" onClick={fetchData} className="text-red-700 underline">
              Retry
            </Button>
          </CardContent>
        </Card>
          ...
          {notifications.map((item) => (
            <button
              ...
              className={cn(
                ...
                !item.is_read && "hover:scale-[1.01] shadow-sm transform"
              )}
            >
