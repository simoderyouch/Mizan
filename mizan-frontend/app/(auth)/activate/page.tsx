...
export default function ActivatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(getApiErrorMessage(err, "Unable to send code. Please verify your email address."));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="sanctuary-card page-enter">
      ...
      <h2 className="text-2xl font-bold mb-1">Activate my account</h2>
      <p className="text-on-surface-variant text-sm mb-8">
        Enter your academic email to receive an activation code.
      </p>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              id="email"
              type="email"
              placeholder="your.email@school.ma"
              value={email}
