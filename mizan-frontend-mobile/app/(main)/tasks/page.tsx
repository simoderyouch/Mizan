  ...
  return (
    <div className="page-enter space-y-8 max-w-6xl mx-auto px-1">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">Mes Tâches</h1>
        <div className="flex items-center gap-3">
          <Badge variant="secondary" className="px-3 py-1 text-sm">
            {todayRemaining} restante(s)
          </Badge>
          {overdueCount > 0 && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-surface-container/40 rounded-2xl border border-outline-variant">
            ...
            <form onSubmit={createManualTask} className="space-y-3">
              ...
              <Button type="submit" disabled={creating} className="w-full">
                {creating ? "Ajout en cours..." : "Ajouter la tâche"}
              </Button>
            </form>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            ...
            {todayTasks.length === 0 ? (
              <p className="text-sm text-on-surface-variant p-4 bg-surface-container rounded-2xl border border-dashed">Aucune tâche pour aujourd&apos;hui.</p>
            ) : (
          ...
          <div>
            ...
            {unfinishedTasks.length === 0 ? (
              <p className="text-sm text-on-surface-variant p-4 bg-surface-container rounded-2xl border border-dashed">Toutes les tâches sont à jour !</p>
            ) : (
