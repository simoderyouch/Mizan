  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="text-center mb-8">
        ...
        />
        <p className="text-on-surface-variant text-sm">Votre espace de sérénité numérique</p>
      </div>
      ...
      <div className="mt-8 flex items-center gap-2 text-xs text-on-surface-variant/60">
        ...
        <span className="uppercase tracking-widest font-semibold">Système sécurisé</span>
      </div>
    </div>
  );
}
