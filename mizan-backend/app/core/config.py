...
class Settings(BaseSettings):
    ...
    CRITICAL_NOTIFICATION_COOLDOWN_HOURS: int = 12
    CRITICAL_NOTIFICATION_MAX_PER_DAY: int = 2
    AGENT_NOTIFICATION_MAX_PER_HOUR: int = 4
    AGENT_TASK_NOTIFICATION_COOLDOWN_HOURS: int = 6
    AGENT_TASK_MAX_PER_HOUR: int = 2
    AGENT_TASK_MAX_PER_DAY: int = 6
    CHAT_TASK_BULK_MAX: int = 5
